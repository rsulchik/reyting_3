...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "StudRate — Talyplaryň öz-özüni bahalandyryş platformasy" },
      { name: "description", content: "Talypdaşlaryňyzy halal bahalandyryň, üstünlikleri gazanyň we toparyňyzyň reýtinginde öňe geçiň." },
